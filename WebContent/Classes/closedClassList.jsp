...
function selectGrade(value){
	 $(document).ready(function(){       
	  $("#content").load("closedClassList.khcu?semester=${semester}&classGrade="+value);
	});   
}
function selectSemester(value){
	 $(document).ready(function(){       
	  $("#content").load("closedClassList.khcu?classGrade=${classGrade}&semester="+value);
	});
 }  
 
function page(value){
	 $(document).ready(function(){
         $("#content").load("closedClassList.khcu?pageNum="+value);     
	 });
}
...
<div id="content">
<center>
<table border="0" width="900"><tr><td align="center"><b>학기별 폐강 목록</b><br><br>
<form name="search" action="closedClassList.khcu" method="post">
